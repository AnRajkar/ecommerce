	...
	static final String pass="";
		...
		public void InsertOrders(Orders o) {
			...
			try{
	            ...
	            */
			     String sql= "insert into orders values('"+o.getOrderId()+"','"+o.getCustomerId()+"','"+o.getProductId()+
			    "','"+o.getQuantity()+"','"+o.getOrderdate()+"','"+o.getDeliverydate()+"','"+o.getPaymenttype()+"','"+o.getDeliveryaddressId()+"','"+o.getReview()+"')";
